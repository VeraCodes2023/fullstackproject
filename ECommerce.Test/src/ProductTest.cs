...
public class ProductTest
{
    ...
    public void CreateProduct_ValidProduct_ReturnsProductReadDTO()
    {
        ...
        var productCreateDto = new ProductCreateDTO
        {
            ...
            Inventory=200,
            CategoryId= new Guid(),
            ImageCreateDTOs = new List<ImageCreateDTO> { new ImageCreateDTO { Url = "https://fakeimg.pl/200x200" } }
        };
    ...
    public void UpdateProduct_ValidIdAndProduct_ReturnsMappedProductReadDTO()
    {
        ...
        var productId = Guid.NewGuid(); 
        var productUpdateDto = new ProductUpdateDTO {Title="update book1", Price=12, Inventory=1000,Description="description",CategoryId= new Guid()};
        ...
        mockProductRepo.Setup(repo => repo.GetById(productId)).Returns(targetProduct);
        mockMapper.Setup(mapper => mapper.Map<List<Image>>(productUpdateDto.ImageUpdateDTOs)).Returns(new List<Image> {});
        mockMapper.Setup(mapper => mapper.Map<ProductReadDTO>(targetProduct)).Returns(mappedResult);
