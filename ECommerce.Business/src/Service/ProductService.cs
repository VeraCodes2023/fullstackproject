...
public class ProductService : IProductService
{
    ...
    public ProductReadDTO CreateProduct(ProductCreateDTO product)
    {
        ...
        try
        {
            ...
            if(product.Images !=null && product.Images.Any())
            {
                ...
                {
                    _mapper.Map<ImageCreateDTO,Image>(image);
                }
            }
    ...
    public ProductReadDTO GetProductById(Guid id)
    {
        ...
        try
        {
            ...
            if(targetProduct != null)
            {
                ...
                mappedResult.Images = _mapper.Map<List<ImageReadDTO>>(targetProduct.Images);
                return mappedResult;
            }
    ...
    public ProdductUpdateReadDTO UpdateProduct(Guid id, ProductUpdateDTO product)
    {
        ...
        try
        {
            ...
            _productRepo.Update(id,targetProduct);
            return _mapper.Map<ProdductUpdateReadDTO>(targetProduct);
        }
        catch (Exception)
        {
            throw;
