...
namespace ECommerce.Controller.UserController
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public ActionResult<ServiceResponse<ProdductUpdateReadDTO>> UpdateProduct(Guid id, [FromBody] ProductUpdateDTO product)
        {
            var serviceResponse = new ServiceResponse<ProdductUpdateReadDTO>();
            try
            {
