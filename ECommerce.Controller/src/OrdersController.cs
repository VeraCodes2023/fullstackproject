...
namespace ECommerce.Controller.OrderController
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        [Authorize(Roles = "Admin")]
        [HttpPut("{id}")]
        public ActionResult<PurchaseReadUpdateDTO> UpdateOrderStatus([FromRoute] Guid id, [FromBody] PurchaseUpdateDTO update)
        {
            var serviceResponse = new ServiceResponse<PurchaseReadUpdateDTO>();
            try
            {
