...
namespace ECommerce.Controller.UserController
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public ActionResult<ServiceResponse<UserReadDTO>>GetUserProfile()
        {
            var serviceResponse = new ServiceResponse<UserReadDTO>();
            try
            {
        ...
        public ActionResult< ServiceResponse<UserReadDTO>> UpdateUserProfile([FromBody] UserUpdateDTO updatedProfile)
        {
            var serviceResponse = new ServiceResponse<UserReadDTO>();
            try
            {
                var userId = GetUserIdClaim();
                var userProfile = _userService.UpdateUserProfile(userId, updatedProfile);
                serviceResponse.Success = true;
                serviceResponse.Data = userProfile;
                serviceResponse.StatusCode = 200;
